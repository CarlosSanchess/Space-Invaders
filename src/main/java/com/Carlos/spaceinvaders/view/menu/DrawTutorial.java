...
public class DrawTutorial extends Viewer<TutorialModel> {
    ...
    protected void draw(LanternaGui gui) {
        ...
        gui.drawText(new PositionModel(33, 24-2), "F", new TextColor.RGB(255, 0 ,0));
        gui.drawText(new PositionModel(38, 24-2), "SHOOT THE POWERUPS TO GAIN POWERS",new TextColor.RGB(255, 255 ,255));

        gui.drawText(new PositionModel(35, 27-2), "POWERUPS", new TextColor.RGB(178, 73 ,210));

        gui.drawText(new PositionModel(29, 30-2), "+", new TextColor.RGB(0, 255 ,0));
        gui.drawText(new PositionModel(38, 30-2), "EXTRA LIFE",new TextColor.RGB(255, 255 ,255));
        gui.drawText(new PositionModel(29, 32-2), "★", new TextColor.RGB(255, 255 ,0));
        gui.drawText(new PositionModel(38, 32-2), "5X SCORE BOOST",new TextColor.RGB(255, 255 ,255));
        gui.drawText(new PositionModel(29, 34-2), "F", new TextColor.RGB(255, 0 ,0));
        gui.drawText(new PositionModel(38, 34-2), "FIRE RATE BOOST",new TextColor.RGB(255, 255 ,255));
